namespace Mapbox.Unity.Ar
{
	...
	public class MessageServiceT : MonoBehaviour {
		...
		/// </summary>
		private static MessageServiceT _instance;
		public static MessageServiceT Instance { get { return _instance; } } 
		...
		public void LoadMessages() {
			...
			MessageProviderT.Instance.LoadARMessages (messageObjectList);
